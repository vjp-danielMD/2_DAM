...
public class VentanaPrincipal extends javax.swing.JFrame {
    ...
    private void leerConFlask(String texto) {
        if (texto.isEmpty() || texto.equals("Respuesta de la IA...")) {
            return;
        }
    ...
    private void initComponents() {
        ...
        btnSTT.setText("ESCUCHAR");
        btnSTT.setBackground(new java.awt.Color(255, 204, 153));
        btnSTT.addActionListener(evt -> btnSTTActionPerformed(evt));
        ...
        btnEnviarIA.setFont(new java.awt.Font("Segoe UI", 1, 12));
        btnEnviarIA.setText("MANDAR");
        btnEnviarIA.addActionListener(evt -> btnEnviarIAActionPerformed(evt));

        btnReproducirVoz.setBackground(new java.awt.Color(204, 204, 255));
        btnReproducirVoz.setFont(new java.awt.Font("Segoe UI", 1, 12));
        btnReproducirVoz.setText("LEER");
        btnReproducirVoz.addActionListener(evt -> btnReproducirVozActionPerformed(evt));
                        ...
                        .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addGroup(layout.createSequentialGroup()
                                                ...
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                                .addComponent(btnSTT)) // <--- AÑADIDO AQUÍ
                                        .addGroup(layout.createSequentialGroup()
                ...
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(jLabel1)
                                        .addComponent(btnSTT)) // <--- AÑADIDO AQUÍ (alineado con el label)
    ...
    private void btnSTTActionPerformed(java.awt.event.ActionEvent evt) {
        btnSTT.setText("Listening...");
        btnSTT.setEnabled(false);

        new Thread(() -> {
            try {
                HttpClient client = HttpClient.newHttpClient();
                HttpRequest request = HttpRequest.newBuilder()
                        .uri(URI.create("http://127.0.0.1:5000/escuchar"))
                        .GET()
                        .build();

                HttpResponse<String> response = client.send(request, HttpResponse.BodyHandlers.ofString());
                String textoEscuchado = response.body();

                SwingUtilities.invokeLater(() -> {
                    if (!textoEscuchado.startsWith("Error:")) {
                        txtPregunta.setText(textoEscuchado);
                    }
                    btnSTT.setText("🎤 ESCUCHAR");
